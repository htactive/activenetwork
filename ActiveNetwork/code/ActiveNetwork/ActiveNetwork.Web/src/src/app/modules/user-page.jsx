...
export class UserPage extends Component {
  ...
  componentWillMount() {
    this.setState({userProfile: {}, isOwner: false});
  }
  ...
  async getProfileData() {
    let dataModel = await UserProfileServiceInstance.getUserProfile(this.props.params.id);
    this.setState({userProfile: dataModel});
  }

  checkOwner() {
    if (userStore.getState().currentUser.Id == this.props.params.id) {
          ...
          <div className="col-md-4 col-xs-12">
            <div className="row-xs">
              <div className="main-box clearfix">
                <h2>{this.state.userProfile.FullName}</h2>
                <div className="profile-status">
                  <i className="fa fa-check-circle"></i> Online
                </div>
                <img src={this.state.userProfile.Avatar != null ? this.state.userProfile.Avatar.Url : ""} alt=""
                  ...
                  <div className="col-sm-8">
                    <div className="profile-user-details clearfix">
                      ...
                      <div className="profile-user-details-value">
                        {this.state.userProfile.BirthDate}
                      </div>
                    </div>
                    <div className="profile-user-details clearfix">
                      <div className="profile-user-details-label">
                      ...
                      <div className="profile-user-details-value">
                        {this.state.userProfile.Gender != null ? this.state.userProfile.Gender.GenderName : "Chưa xác định"}
                      </div>
                    </div>
                    <div className="profile-user-details clearfix">
                      <div className="profile-user-details-label">
                        ...
                        <div className="col-md-12">
                          <div className="box box-widget">
                            ...
                            <div className="box-body">
                              ...
                              <button type="button" className="btn btn-default btn-xs"><i className="fa fa-share"></i>
                                Share
                              </button>
                              <button type="button" className="btn btn-default btn-xs"><i
